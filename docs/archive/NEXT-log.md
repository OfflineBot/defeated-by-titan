# NEXT — archive, the log up to the 2026-08-13 specs

Updated: 2026-08-29 · Stage: 🟧 (a record, kept whole)

> **Why this file exists.** `docs/NEXT.md` had reached **117 kB across 41 sections** and had
> stopped being a queue: it was a chronological log, so the one question it exists for —
> *what do I do next?* — could not be read out of it. Everything here is dated 2026-08-12 or
> earlier, or is a round that closed. **Nothing was deleted**, and every verbatim quote from him
> came with it.
>
> Grep for the section number; never open this whole.
