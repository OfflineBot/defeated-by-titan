...
| Modus: Breach (Verteidigung) | F-072 | 🟨 | scripts/f072-breach.txt 14 asserts held, exit 0 [offlinebot 2026-09-01] | 2026-09-01 THE LEDGER WAS WRONG, corrected against the tree — eight files name it and its mode plays end to end. |
| Modus: Escort | F-073 | ⬜ | — | — |
...
| Getaggte Ankerflaechen (Ebene 1) | F-003 | 🟨 | 79 blocks from maps.ron (9 placed, 70 seeded, 63 taggable) · docs/images/f003-city.png and f003-anchors.png · tests/world.rs, red-checked: half-edge collider reports 'factor 0.50 against the file' | 2026-08-27 THE TAG RULE IS CANCELLED but its DATA stays as a switch. He chose 'Wirklich ALLES hakbar' and then added 'spaeter soll man auch bestimmte sachen toggeln koennen ... aber grundsetzlich erstmal ales!'. So maps.ron: anchorable is not deleted - it becomes a filter that is on everywhere today. Measured while retiring the field: the shipped map prints '2901 blocks built, 2901 of them anchorable', so there is no untagged block on Ashgate at all and this rule was covering nothing. docs/QUESTIONS.md Q-078. |
...
| Boost-Dash | F-008 | 🟨 | scripts/f008-dash.txt 3 asserts held / 391 ticks, exit 0 [offlinebot 2026-08-27] · src/vector/dodge.rs 249 lines, charges/recharge/cooldown in spend_and_recharge, registered in VectorPlugin · game.ron carries dodge_charges 3, dodge_recharge_s, dodge_cooldown_s, gas_dodge | 2026-08-27 THE LEDGER WAS WRONG, corrected against the tree. This row read Unbuilt while the feature had 249 lines of code, a green evidence script and its own RON keys. It is 'Built' and not 'Proven': nobody has photographed a dash. One of 52 Unbuilt rows the tree names - docs/PLAN.md section 3 records that staleness as a root cause of seven circling rounds. |
...
| Item | ID | Stage | Evidence (test / screenshot / number) | Note |
|---|---|---|---|---|
| Highlighting der Ankerpunkte | F-026 | 🟨 | — | 2026-08-29 STAGE PULLED BACK BY THE USER'S EYE. He played it and said: 'ist immernoch nicht am cursor. es bewegt sich immernoch also die target seile' and 'zudem steht no target selbst wenn ich ein seil dran hab'. The 0.0 px evidence for FIND-129 was a projection AT ONE TICK, decoded from a screenshot; he is describing MOTION, which nothing has measured. docs/NEXT.md 5A. |
| Diskrete Ankerpunkte (Ebene 2) | F-021 | ⬜ | — | 2026-08-27 CANCELLED BY THE USER, do not build. He was asked how the hook should find its target and answered: 'es soll auf jeglicher oberflqche einhaken. nicht an hardcoded punkten etc!' - so hooking is a property of SURFACES and the whole authored-anchor-point line is the wrong idea, not an unfinished one. world::AnchorField (787 lines) and hud::anchor_marks were deleted on 2026-08-27, 2638 lines, and the raycast that was always there is the only path. See docs/QUESTIONS.md Q-067 and Q-078 and docs/PLAN.md section 0. WHAT SURVIVES AND IS NOT THIS ROW: the aim assist (assist_catch_pct / assist_strength_pct, vector::aim::probe_dirs) sweeps the RAY sideways for a surface and never read the point list - he asked for it twice. |
| Prozedurale Ankerpunkt-Erzeugung | F-022 | ⬜ | — | 2026-08-27 CANCELLED BY THE USER, do not build. He was asked how the hook should find its target and answered: 'es soll auf jeglicher oberflqche einhaken. nicht an hardcoded punkten etc!' - so hooking is a property of SURFACES and the whole authored-anchor-point line is the wrong idea, not an unfinished one. world::AnchorField (787 lines) and hud::anchor_marks were deleted on 2026-08-27, 2638 lines, and the raycast that was always there is the only path. See docs/QUESTIONS.md Q-067 and Q-078 and docs/PLAN.md section 0. WHAT SURVIVES AND IS NOT THIS ROW: the aim assist (assist_catch_pct / assist_strength_pct, vector::aim::probe_dirs) sweeps the RAY sideways for a surface and never read the point list - he asked for it twice. |
| Kandidatensuche mit Hemisphaeren-Aufteilung | F-023 | ⬜ | — | 2026-08-27 CANCELLED BY THE USER, do not build. He was asked how the hook should find its target and answered: 'es soll auf jeglicher oberflqche einhaken. nicht an hardcoded punkten etc!' - so hooking is a property of SURFACES and the whole authored-anchor-point line is the wrong idea, not an unfinished one. world::AnchorField (787 lines) and hud::anchor_marks were deleted on 2026-08-27, 2638 lines, and the raycast that was always there is the only path. See docs/QUESTIONS.md Q-067 and Q-078 and docs/PLAN.md section 0. WHAT SURVIVES AND IS NOT THIS ROW: the aim assist (assist_catch_pct / assist_strength_pct, vector::aim::probe_dirs) sweeps the RAY sideways for a surface and never read the point list - he asked for it twice. |
| Snap auf Q und E | F-024 | ⬜ | — | 2026-08-27 CANCELLED BY THE USER, do not build. He was asked how the hook should find its target and answered: 'es soll auf jeglicher oberflqche einhaken. nicht an hardcoded punkten etc!' - so hooking is a property of SURFACES and the whole authored-anchor-point line is the wrong idea, not an unfinished one. world::AnchorField (787 lines) and hud::anchor_marks were deleted on 2026-08-27, 2638 lines, and the raycast that was always there is the only path. See docs/QUESTIONS.md Q-067 and Q-078 and docs/PLAN.md section 0. WHAT SURVIVES AND IS NOT THIS ROW: the aim assist (assist_catch_pct / assist_strength_pct, vector::aim::probe_dirs) sweeps the RAY sideways for a surface and never read the point list - he asked for it twice. |
| Bewertungsfunktion fuer Kandidaten | F-025 | ⬜ | — | 2026-08-27 CANCELLED BY THE USER, do not build. He was asked how the hook should find its target and answered: 'es soll auf jeglicher oberflqche einhaken. nicht an hardcoded punkten etc!' - so hooking is a property of SURFACES and the whole authored-anchor-point line is the wrong idea, not an unfinished one. world::AnchorField (787 lines) and hud::anchor_marks were deleted on 2026-08-27, 2638 lines, and the raycast that was always there is the only path. See docs/QUESTIONS.md Q-067 and Q-078 and docs/PLAN.md section 0. WHAT SURVIVES AND IS NOT THIS ROW: the aim assist (assist_catch_pct / assist_strength_pct, vector::aim::probe_dirs) sweeps the RAY sideways for a surface and never read the point list - he asked for it twice. |
| Marker-Dichtebegrenzung | F-027 | ⬜ | — | 2026-08-27 CANCELLED BY THE USER, do not build. He was asked how the hook should find its target and answered: 'es soll auf jeglicher oberflqche einhaken. nicht an hardcoded punkten etc!' - so hooking is a property of SURFACES and the whole authored-anchor-point line is the wrong idea, not an unfinished one. world::AnchorField (787 lines) and hud::anchor_marks were deleted on 2026-08-27, 2638 lines, and the raycast that was always there is the only path. See docs/QUESTIONS.md Q-067 and Q-078 and docs/PLAN.md section 0. WHAT SURVIVES AND IS NOT THIS ROW: the aim assist (assist_catch_pct / assist_strength_pct, vector::aim::probe_dirs) sweeps the RAY sideways for a surface and never read the point list - he asked for it twice. |
| Fallback ohne Kandidat | F-028 | ⬜ | — | 2026-08-27 CANCELLED BY THE USER, do not build. He was asked how the hook should find its target and answered: 'es soll auf jeglicher oberflqche einhaken. nicht an hardcoded punkten etc!' - so hooking is a property of SURFACES and the whole authored-anchor-point line is the wrong idea, not an unfinished one. world::AnchorField (787 lines) and hud::anchor_marks were deleted on 2026-08-27, 2638 lines, and the raycast that was always there is the only path. See docs/QUESTIONS.md Q-067 and Q-078 and docs/PLAN.md section 0. WHAT SURVIVES AND IS NOT THIS ROW: the aim assist (assist_catch_pct / assist_strength_pct, vector::aim::probe_dirs) sweeps the RAY sideways for a surface and never read the point list - he asked for it twice. |
| Performance der Kandidatensuche | F-030a | ⬜ | — | 2026-08-27 CANCELLED BY THE USER, do not build. He was asked how the hook should find its target and answered: 'es soll auf jeglicher oberflqche einhaken. nicht an hardcoded punkten etc!' - so hooking is a property of SURFACES and the whole authored-anchor-point line is the wrong idea, not an unfinished one. world::AnchorField (787 lines) and hud::anchor_marks were deleted on 2026-08-27, 2638 lines, and the raycast that was always there is the only path. See docs/QUESTIONS.md Q-067 and Q-078 and docs/PLAN.md section 0. WHAT SURVIVES AND IS NOT THIS ROW: the aim assist (assist_catch_pct / assist_strength_pct, vector::aim::probe_dirs) sweeps the RAY sideways for a surface and never read the point list - he asked for it twice. |
| Ankerpunkt-Validierung im Editor | F-031a | ⬜ | — | 2026-08-27 CANCELLED BY THE USER, do not build. He was asked how the hook should find its target and answered: 'es soll auf jeglicher oberflqche einhaken. nicht an hardcoded punkten etc!' - so hooking is a property of SURFACES and the whole authored-anchor-point line is the wrong idea, not an unfinished one. world::AnchorField (787 lines) and hud::anchor_marks were deleted on 2026-08-27, 2638 lines, and the raycast that was always there is the only path. See docs/QUESTIONS.md Q-067 and Q-078 and docs/PLAN.md section 0. WHAT SURVIVES AND IS NOT THIS ROW: the aim assist (assist_catch_pct / assist_strength_pct, vector::aim::probe_dirs) sweeps the RAY sideways for a surface and never read the point list - he asked for it twice. |
| The Rookery (Hub) | M-001 | ⬜ | — | — |
| Ashgate District | M-002 | ⬜ | — | — |
| Brackwall | M-003 | ⬜ | — | — |
| The Fallow | M-004 | ⬜ | — | — |
| Titanwood | M-005 | ⬜ | — | — |
...
| Saltpier | M-007 | ⬜ | — | — |
| Highspire | M-008 | ⬜ | — | — |
| The Breach (Raid) | M-009 | ⬜ | — | — |
| The Hollow (Raid) | M-010 | ⬜ | — | — |
| Trade Hall | M-012 | ⬜ | — | — |
