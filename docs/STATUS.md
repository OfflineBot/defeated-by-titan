...
| Highlighting der Ankerpunkte | F-026 | ⬜ | — | 2026-08-27 CANCELLED BY THE USER, do not build. He was asked how the hook should find its target and answered: 'es soll auf jeglicher oberflqche einhaken. nicht an hardcoded punkten etc!' - so hooking is a property of SURFACES and the whole authored-anchor-point line is the wrong idea, not an unfinished one. world::AnchorField (787 lines) and hud::anchor_marks were deleted on 2026-08-27, 2638 lines, and the raycast that was always there is the only path. See docs/QUESTIONS.md Q-067 and Q-078 and docs/PLAN.md section 0. WHAT SURVIVES AND IS NOT THIS ROW: the aim assist (assist_catch_pct / assist_strength_pct, vector::aim::probe_dirs) sweeps the RAY sideways for a surface and never read the point list - he asked for it twice. |
